...
namespace phpreprocess {
    ...
    /**/
    {
        ...
        /**
         * Write error using preprocessors error method, adding additional info
         * such as plugin name.
         *
         * @octdoc  m:plugin/error
         * @param   string          $message        Message to display.
         */
        protected function error($message)
        /**/
        {
            $this->preprocessor->error(sprintf(
                "%s\n  plugin : %s",
                $message,
                get_class($this)
            ));
        ...
        /**
         * Method returns the preprocessor instance.
         *
         * @octdoc  m:plugin/getPreprocessor
         * @return  preprocessor                    Instance of preprocessor.
         */
